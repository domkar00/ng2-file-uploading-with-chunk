...
export declare class FileUploader {
    ...
    onCompleteChunk(item: FileItem, response: string, status: number, headers: ParsedResponseHeaders): any;
    ...
    _onCompleteChunk(item: FileItem, response: string, status: number, headers: ParsedResponseHeaders): void;
    ...
    protected _buildMultiPartSendable(item: FileItem, start?: number, end?: number): FormData;
